...
const Banner = ({query,handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14' style={{paddingLeft:6 +"rem"}}>
   ...
   <form>
    <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
        <div className='flex md:rounded-s-md rounded shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full'>
            <input type='text' name='title' id='title'placeholder=' What position are you looking for ?' className='block flex-1 border-0 bg-transparent py-1.5 p1-8 text-gray-900 placeholder:text-gray-400 focus:right-0 sm:text-sm sm:leading-6' style={{paddingLeft:1.5 +"rem"}} 
        ...
        <div className='flex md:rounded-s-none rounded shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/3 w-full'>
            <input type='text' name='title' id='title'placeholder='Location' className='block flex-1 border-0 bg-transparent py-1.5 p1-8 text-gray-900 placeholder:text-gray-400 focus:right-0 sm:text-sm sm:leading-6' style={{paddingLeft:2 +"rem"}} 
            onChange={handleInputChange}
            value={""}
            />
